...
type Order struct {
	...
	// CustomerConfirmedAt is set when the customer self-reports the package
	// arrived — deliberately separate from Status, which stays under admin
	// control. See docs/16-plan-konfirmasi-pesanan-diterima-review.md.
	CustomerConfirmedAt *time.Time `db:"customer_confirmed_at"`
